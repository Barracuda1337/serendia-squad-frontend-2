    ...
    >
      ...
      <section class="flex flex-col">
        ...
        >
          ...
          <div
            class="flex flex-col text-left w-full mt-2"
            v-bind:class="{ hidden: !code.active }"
          >
            <ul>
              ...
              <li class="py-2">
                ...
                <button
                  class="py-2 px-4 mr-2 bg-red-500 hover:bg-red-600 rounded"
                >
                  Reddet
                </button>
                <button class="py-2 px-4 bg-red-600 hover:bg-red-700 rounded">
                  Yasakla
                </button>
              </li>
            </ul>
